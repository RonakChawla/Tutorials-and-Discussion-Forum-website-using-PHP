...
<head>
    ...
    <title>ComputerScienceTutorials | Discussion Forum</title>
</head>
...
<body>
    ...
    <div class="container my-4" id="ques">
        <h2 class="text-center my-4">ComputerScienceTutorials - Discussions | Browse Categories</h2>
        <div class="row my-4">
        ...
        <?php 
            ...
            '<div class="col-md-4 my-2">
                <div class="card" style="width: 18rem;">
                    <img src="images/'. $cat .'.jpg" class="card-img-top" alt="image for this category">
                    <div class="card-body">
